...
async def run_guardkeeper(
    payload: dict, reply_type: str | None = None, trace_id: str | None = None
) -> None:
    """
    ...
    telemetry.emit(
        ...
        source="lore",
        destination="agent",
        metadata={"reply_type": reply_type or "mr_open"},
    )
    ...
    try:
        if reply_type is not None:
            ...
            if reply_type == "accidental":
                ...
                finish("accidental_acknowledged")
                return
        ...
        # — Step 6: Call Claude —
        system_prompt = llm.load_prompt("guardkeeper")
