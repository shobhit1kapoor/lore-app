...
async def run_lorekeeper(payload: dict, trace_id: str | None = None) -> None:
    """
    ...
    try:
        ...
        if len(meaningful) < 2:
            ...
            finish("no_meaningful_discussion")
            return
        ...
        # — Step 6: Call Claude —
        system_prompt = llm.load_prompt("lorekeeper")
